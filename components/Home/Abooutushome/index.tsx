...
const Aboutus = () => {
    return (
        <>
            <div className="bg-gradient-to-r from-[#CCCCCC] to-[#AECEEA] mb-20 relative">
                <div className="max-w-[88vw] mx-auto flex flex-wrap items-center justify-center px-4">
                    ...
                    <div className="w-full sm:w-1/2 p-2 flex justify-center">
                        <Image
                            ...
                            alt="image"
                            width={450} // Original width
                            height={300} // Original height
                            className="object-cover max-w-full h-auto duration-300 ease-in-out hover:-translate-y-4 hover:scale-110 transition-transform" 
                        />
                    </div>
